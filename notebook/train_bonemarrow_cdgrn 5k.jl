...
Gadfly.with_theme(style(grid_line_style=:solid)) do
    ...
    draw(SVG("pics/bonemarrow/CDGRN/context-global histogram.svg", 6inch, 4inch), p)
    draw(PNG("pics/bonemarrow/CDGRN/context-global histogram.png", 6inch, 4inch), p)
end
...
Gadfly.with_theme(style(grid_line_style=:solid)) do
    ...
    draw(SVG("pics/bonemarrow/CDGRN/context-global cdf.svg", 6inch, 4inch), p)
    draw(PNG("pics/bonemarrow/CDGRN/context-global cdf.png", 6inch, 4inch), p)
end
...
Gadfly.with_theme(style(grid_line_style=:solid)) do
    p = plot(plot_df2, x=:ρ, color=:condition, alpha=:alpha,
             Geom.histogram(position=:identity, bincount=bincount), Guide.xlabel("TF-target pair correlation"))
    draw(SVG("pics/bonemarrow/CDGRN/unspliced-spliced histogram.svg", 6inch, 4inch), p)
    draw(PNG("pics/bonemarrow/CDGRN/unspliced-spliced histogram.png", 6inch, 4inch), p)
end
...
Gadfly.with_theme(style(grid_line_style=:solid)) do
    p = plot(cdf_df, x=:x, y=:y, color=:condition,
            Geom.step, Guide.xlabel("TF-target pair correlation"), Guide.yticks(ticks=[0., 0.25, 0.5, 0.75, 1.]))
    draw(SVG("pics/bonemarrow/CDGRN/unspliced-spliced cdf.svg", 6inch, 4inch), p)
    draw(PNG("pics/bonemarrow/CDGRN/unspliced-spliced cdf.png", 6inch, 4inch), p)
end
...
filepath = joinpath(CDGRN.PROJECT_PATH, "pics", "bonemarrow", "CDGRN", "cell clusters k3-3.html")
savefig(p, filepath)
...
filepath = joinpath(CDGRN.PROJECT_PATH, "pics", "bonemarrow", "CDGRN", "k5-3 regulation $target.html")
savefig(p, filepath)
# spliced
p = plot_regulations(data, "E2f1", target, spliced=true)
filepath = joinpath(CDGRN.PROJECT_PATH, "pics", "bonemarrow", "CDGRN", "k5-3 regulation $target (spliced).html")
savefig(p, filepath)
# global
data = make_vis_data(target, tfs, prof, true_regulations)
p = plot_regulations(data, "E2f1", target)
filepath = joinpath(CDGRN.PROJECT_PATH, "pics", "bonemarrow", "CDGRN", "k5-3 regulation $target (global).html")
savefig(p, filepath)
...
data = make_vis_data(target, tfs, prof, true_regulations, cluster=context)
p = plot_regulations(data, "E2f1", target, model=cdgrn.models[Symbol(target)])
filepath = joinpath(CDGRN.PROJECT_PATH, "pics", "bonemarrow", "CDGRN", "k5-2 regulation $target.html")
savefig(p, filepath)
...
filepath = joinpath(CDGRN.PROJECT_PATH, "pics", "bonemarrow", "CDGRN", "k5-4 regulation $target.html")
savefig(p, filepath)
...
filepath = joinpath(CDGRN.PROJECT_PATH, "pics", "bonemarrow", "CDGRN", "k5-4 regulation $target (spliced).html")
savefig(p, filepath)
# global
data = make_vis_data(target, tfs, prof, true_regulations)
p = plot_regulations(data, "Elf5", target)
filepath = joinpath(CDGRN.PROJECT_PATH, "pics", "bonemarrow", "CDGRN", "k5-4 regulation $target (global).html")
savefig(p, filepath)
