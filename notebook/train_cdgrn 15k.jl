...
countmap(cell_clusters[cell_clusters.k15 .== 3, :cell])


# Select context

context = cell_clusters.k15 .== 1
# context = cell_clusters.k15 .== 4
# context = cell_clusters.k15 .== 11
...
CSV.write("/media/yuehhua/Workbench/workspace/GRN/results/cdgrn_k15/cdgrn_k15-1.csv", context_cor)

## Effective gene set
c = context_cor[context_cor.regulation_strength .≥ 0.3, :]
gene_set = DataFrame(gene=unique!(vcat(c.tf, c.target)))
CSV.write("/media/yuehhua/Workbench/workspace/GRN/results/cdgrn_k15/cdgrn_k15-1_gene_set.csv", gene_set)
